...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_AMERICA', 'UNIT_AMERICAN_MINUTEMAN', 0, 'UNIT_MUSKETMAN', 'UNIT_LINE_INFANTRY', 'UNIT_MUSKETMAN');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_ARABIA', 'UNIT_ARABIAN_GHAZI', 0, 'UNIT_MAN_AT_ARMS', 'UNIT_MAN_AT_ARMS', 'UNIT_SWORDSMAN');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_BRAZIL', 'UNIT_BRAZILIAN_FATHERLAND_VOLUNTEER', 0, 'UNIT_LINE_INFANTRY', 'UNIT_INFANTRY', 'UNIT_INFANTRY');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_GREECE', 'UNIT_GREEK_ARMATOLOS', 0, 'UNIT_LINE_INFANTRY', 'UNIT_INFANTRY', 'UNIT_INFANTRY');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_INDIA', 'UNIT_INDIAN_SEPOY', 1, 'UNIT_LINE_INFANTRY', 'UNIT_INFANTRY', 'UNIT_INFANTRY');
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_JAPAN', 'UNIT_JAPANESE_SOHEI', 1, 'UNIT_PIKEMAN', 'UNIT_MUSKETMAN', 'UNIT_PIKEMAN');
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_JAPAN', 'UNIT_JAPANESE_YAMATO', 0, 'UNIT_BATTLESHIP', 'UNIT_MISSILE_CRUISER', 'UNIT_BATTLESHIP');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_NORWAY', 'UNIT_NORWEGIAN_HIRDMAN', 0, 'UNIT_SWORDSMAN', 'UNIT_MAN_AT_ARMS', 'UNIT_SWORDSMAN');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_ROME', 'UNIT_ROMAN_ONAGER', 0, 'UNIT_CATAPULT', 'UNIT_TREBUCHET', 'UNIT_CATAPULT');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_AZTEC', 'UNIT_AZTEC_JAGUAR', 1, 'UNIT_SWORDSMAN', 'UNIT_MAN_AT_ARMS', 'UNIT_SWORDSMAN');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_POLAND', 'UNIT_POLISH_CHOSEN_INFANTRY', 0, 'UNIT_MUSKETMAN', 'UNIT_LINE_INFANTRY', 'UNIT_MUSKETMAN');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_MACEDON', 'UNIT_MACEDONIAN_BALLISTA', 1, 'UNIT_CATAPULT', 'UNIT_TREBUCHET', 'UNIT_CATAPULT');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_NETHERLANDS', 'UNIT_DUTCH_SCHUTTERIJ', 1, 'UNIT_MUSKETMAN', 'UNIT_LINE_INFANTRY', 'UNIT_MUSKETMAN');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_SCOTLAND', 'UNIT_SCOTTISH_GALLOWGLASS', 1, 'UNIT_MAN_AT_ARMS', 'UNIT_MUSKETMAN', 'UNIT_SWORDSMAN');
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_MONGOLIA', 'UNIT_MONGOLIAN_HUI_HUI_PAO', 1, 'UNIT_TREBUCHET', 'UNIT_BOMBARD', 'UNIT_CATAPULT');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('LEADER_ELEANOR_ENGLAND', 'UNIT_ELEANOR_TEMPLAR', 1, 'UNIT_MAN_AT_ARMS', 'UNIT_MUSKETMAN', 'UNIT_SWORDSMAN');

-- New Frontier UUs
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_MAYA', 'UNIT_MAYAN_HOLKAN', 1, 'UNIT_MAN_AT_ARMS', 'UNIT_MUSKETMAN', 'UNIT_SWORDSMAN');
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_GRAN_COLOMBIA', 'UNIT_COLOMBIAN_BRITISH_LEGION', 1, 'UNIT_LINE_INFANTRY', 'UNIT_INFANTRY', 'UNIT_MUSKETMAN');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_BYZANTIUM', 'UNIT_BYZANTINE_VARANGIAN_GUARD', 1, 'UNIT_MAN_AT_ARMS', 'UNIT_MUSKETMAN', 'UNIT_SWORDSMAN');
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_ETHIOPIA', 'UNIT_ETHIOPIAN_MEHAL_SEFARI', 1, 'UNIT_LINE_INFANTRY', 'UNIT_INFANTRY', 'UNIT_MUSKETMAN');
...
INSERT INTO EnabledUniqueUnits (OwnerType, Type, Enabled, DefaultReplaces, DefaultUpgrade, UnitAiBaseUnit) VALUES ('CIVILIZATION_PORTUGAL', 'UNIT_PORTUGUESE_KNIGHT_OF_AVIZ', 1, 'UNIT_KNIGHT', 'UNIT_TANK', 'UNIT_KNIGHT');
