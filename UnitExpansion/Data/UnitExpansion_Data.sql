...
-- INSERT INTO Types (Type, Kind) SELECT 'UNIT_DLV_RIFLEMAN', 'KIND_UNIT' WHERE NOT EXISTS (SELECT 1 FROM Types WHERE Type = 'UNIT_LINE_INFANTRY');
-- INSERT INTO Types (Type, Kind) SELECT 'UNIT_DLV_LONGSWORDSMAN', 'KIND_UNIT' WHERE NOT EXISTS (SELECT 1 FROM Types WHERE Type = 'UNIT_MAN_AT_ARMS');
-- INSERT INTO Types (Type, Kind) SELECT 'UNIT_DLV_TREBUCHET', 'KIND_UNIT' WHERE NOT EXISTS (SELECT 1 FROM Types WHERE Type = 'UNIT_TREBUCHET');
...
-- INSERT INTO Units (UnitType, BaseMoves, Cost, AdvisorType, BaseSightRange, ZoneOfControl, Domain, FormationClass, Name, Description, PurchaseYield, PromotionClass, Maintenance, Combat, StrategicResource, PrereqTech, MandatoryObsoleteTech)
-- SELECT 'UNIT_DLV_RIFLEMAN', '2', '310', 'ADVISOR_CONQUEST', '2', 1, 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', 'LOC_UNIT_RIFLEMAN_NAME', 'LOC_UNIT_RIFLEMAN_DESCRIPTION', 'YIELD_GOLD', 'PROMOTION_CLASS_MELEE', '5', '64', 'RESOURCE_NITER', 'TECH_RIFLING', 'TECH_SATELLITES'
-- WHERE NOT EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_LINE_INFANTRY');
...
-- AND    NOT EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_LINE_INFANTRY');
...
-- SELECT 'UNIT_DLV_TREBUCHET', '2', '200', 'ADVISOR_CONQUEST', '2', 0, 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', 'LOC_UNIT_TREBUCHET_NAME', 'LOC_UNIT_TREBUCHET_DESCRIPTION', 'YIELD_GOLD', 'PROMOTION_CLASS_SIEGE', '3', '33', '2', '45', 'TECH_MILITARY_ENGINEERING', 'TECH_BALLISTICS'
-- WHERE NOT EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_TREBUCHET');


-- INSERT INTO Units (UnitType, BaseMoves, Cost, AdvisorType, BaseSightRange, ZoneOfControl, Domain, FormationClass, Name, Description, PurchaseYield, PromotionClass, Maintenance, Combat, StrategicResource, PrereqTech, MandatoryObsoleteTech) 
-- SELECT 'UNIT_DLV_LONGSWORDSMAN', '2', '160', 'ADVISOR_CONQUEST', '2', 1, 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', 'LOC_UNIT_LONGSWORDSMAN_NAME', 'LOC_UNIT_LONGSWORDSMAN_DESCRIPTION', 'YIELD_GOLD', 'PROMOTION_CLASS_MELEE', '2', '46', 'RESOURCE_IRON', 'TECH_CASTLES', 'TECH_REPLACEABLE_PARTS'
-- WHERE NOT EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_MAN_AT_ARMS');

-- INSERT INTO Units_XP2 (UnitType, ResourceMaintenanceAmount, ResourceCost, ResourceMaintenanceType, TourismBomb, CanEarnExperience, TourismBombPossible, CanFormMilitaryFormation, MajorCivOnly)
-- SELECT 'UNIT_DLV_LONGSWORDSMAN', 0, 20, NULL, 0, 1, 0, 1, 0
-- WHERE NOT EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_MAN_AT_ARMS');
...
-- INSERT OR REPLACE INTO UnitReplaces (CivUniqueUnitType, ReplacesUnitType) SELECT 'UNIT_JAPANESE_SAMURAI', 'UNIT_DLV_LONGSWORDSMAN' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
-- INSERT OR REPLACE INTO UnitReplaces (CivUniqueUnitType, ReplacesUnitType) SELECT 'UNIT_ENGLISH_REDCOAT', 'UNIT_DLV_RIFLEMAN' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');
-- INSERT OR REPLACE INTO UnitReplaces (CivUniqueUnitType, ReplacesUnitType) SELECT 'UNIT_FRENCH_GARDE_IMPERIALE', 'UNIT_DLV_RIFLEMAN' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');

--UnitUpgrades
-- INSERT OR REPLACE INTO UnitUpgrades (Unit, UpgradeUnit) SELECT 'UNIT_DLV_TREBUCHET', 'UNIT_BOMBARD' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_TREBUCHET');
-- INSERT OR REPLACE INTO UnitUpgrades (Unit, UpgradeUnit) SELECT 'UNIT_DLV_LONGSWORDSMAN', 'UNIT_MUSKETMAN' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
-- INSERT OR REPLACE INTO UnitUpgrades (Unit, UpgradeUnit) SELECT 'UNIT_DLV_RIFLEMAN', 'UNIT_INFANTRY' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');
...
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_LONGSWORDSMAN', 'UNITAI_COMBAT' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_LONGSWORDSMAN', 'UNITAI_EXPLORE' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_LONGSWORDSMAN', 'UNITTYPE_MELEE' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_LONGSWORDSMAN', 'UNITTYPE_LAND_COMBAT' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_RIFLEMAN', 'UNITAI_COMBAT' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_RIFLEMAN', 'UNITAI_EXPLORE' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_RIFLEMAN', 'UNITTYPE_MELEE' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_RIFLEMAN', 'UNITTYPE_LAND_COMBAT' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_GATLING_GUN', 'UNITAI_COMBAT' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_GATLING_GUN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_GATLING_GUN', 'UNITAI_EXPLORE' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_GATLING_GUN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_GATLING_GUN', 'UNITTYPE_RANGED' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_GATLING_GUN');
-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_GATLING_GUN', 'UNITTYPE_LAND_COMBAT' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_GATLING_GUN');

-- INSERT INTO UnitAIInfos (UnitType, AiType) SELECT 'UNIT_DLV_TREBUCHET', AiType FROM UnitAiInfos WHERE UnitType = 'UNIT_CATAPULT' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_TREBUCHET');
...
-- INSERT INTO TypeTags (Type, Tag) SELECT 'UNIT_DLV_LONGSWORDSMAN', Tag FROM TypeTags WHERE Type = 'UNIT_SWORDSMAN' AND Tag LIKE 'CLASS_%' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
-- INSERT INTO TypeTags (Type, Tag) SELECT 'UNIT_DLV_RIFLEMAN', Tag FROM TypeTags WHERE Type = 'UNIT_MUSKETMAN' AND Tag LIKE 'CLASS_%' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');
-- INSERT INTO TypeTags (Type, Tag) SELECT 'UNIT_DLV_MORTAR', Tag FROM TypeTags WHERE Type = 'UNIT_FIELD_CANNON' AND Tag LIKE 'CLASS_%';
-- INSERT INTO TypeTags (Type, Tag) SELECT 'UNIT_DLV_TREBUCHET', Tag FROM TypeTags WHERE Type = 'UNIT_CATAPULT' AND Tag LIKE 'CLASS_%' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_TREBUCHET');
...
-- INSERT INTO TypeTags (Type, Tag) SELECT 'UNIT_DLV_RIFLEMAN', 'CLASS_GUNPOWDER_MELEE' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');
-- INSERT INTO TypeTags (Type, Tag) SELECT 'UNIT_LINE_INFANTRY', 'CLASS_GUNPOWDER_MELEE' WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_LINE_INFANTRY');
...
-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_TREBUCHET' WHERE Unit = 'UNIT_CATAPULT' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_TREBUCHET');

-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_RIFLEMAN' WHERE Unit = 'UNIT_MUSKETMAN' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');

-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_RIFLEMAN' WHERE Unit = 'UNIT_SPANISH_CONQUISTADOR' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');

-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_LONGSWORDSMAN' WHERE Unit = 'UNIT_SWORDSMAN' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');

-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_LONGSWORDSMAN' WHERE Unit = 'UNIT_ROMAN_LEGION' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');

-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_LONGSWORDSMAN' WHERE Unit = 'UNIT_KONGO_SHIELD_BEARER' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
...
-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_LONGSWORDSMAN' WHERE Unit = 'UNIT_PERSIAN_IMMORTAL' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_PERSIAN_IMMORTAL') AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');

-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_LONGSWORDSMAN' WHERE Unit = 'UNIT_MACEDONIAN_HYPASPIST' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_MACEDONIAN_HYPASPIST') AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
...
-- INSERT INTO UnitReplaces (CivUniqueUnitType, ReplacesUnitType) SELECT UnitType,'UNIT_DLV_TREBUCHET' FROM Units WHERE UnitType = 'UNIT_KHMER_DOMREY' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_TREBUCHET');

-- INSERT INTO UnitReplaces (CivUniqueUnitType, ReplacesUnitType) SELECT UnitType,'UNIT_DLV_LONGSWORDSMAN' FROM Units WHERE UnitType = 'UNIT_GEORGIAN_KHEVSURETI' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
...
-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_LONGSWORDSMAN' WHERE Unit = 'UNIT_MAORI_TOA' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_MAORI_TOA') AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_LONGSWORDSMAN');
...
-- UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_RIFLEMAN' WHERE Unit = 'UNIT_SULEIMAN_JANISSARY' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_SULEIMAN_JANISSARY') AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DLV_RIFLEMAN');