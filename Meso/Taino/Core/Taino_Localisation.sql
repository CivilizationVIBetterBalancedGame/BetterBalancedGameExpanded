...
-----------------------------------------------
	...
	("en_US",	"LOC_ABILITY_CVS_TAINO_UU_DESCRIPTION", "Upon eliminating an enemy unit, earns [ICON_Faith] Faith equal to half the [ICON_Strength] Combat Strength of the defeated unit."),
...
-----------------------------------------------
	...
	("en_US",	"LOC_NAMED_RIVER_ARTIBONITE",	"Artibonite"	),
	("en_US",	"LOC_NAMED_RIVER_THOA",			"Thoa"			),
	("en_US",	"LOC_NAMED_RIVER_YAQUE",		"Yaque"			),
	("en_US",	"LOC_NAMED_RIVER_YAQUE",		"Yaque"			),
	("en_US",	"LOC_NAMED_RIVER_YUNA",			"Yuna"			),
	("en_US",	"LOC_NAMED_RIVER_OZAMA",		"Ozama"			),
