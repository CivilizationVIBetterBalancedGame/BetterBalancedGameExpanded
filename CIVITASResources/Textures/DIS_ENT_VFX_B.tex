...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Districts/Entertainment/03_Texture/DIS_ENT_VFX_B.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3734509729</m_ExportedTime>
	<m_ClassName text="Generic_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="DIS_ENT_VFX_B.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="DIS_ENT_VFX_B"/>
	<m_Description text=""/>
	<m_Tags>
