...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="V:\Civ Textures\Civ 6\Art Templates\Resources\Icons\Atlases\p0k_Resources_MODE_Atlas_FOW.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>861886124</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="p0k_Resources_MODE_Atlas_FOW.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="p0k_Resources_MODE_Atlas_FOW"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
